...
import 'tsignup_model.dart';
export 'tsignup_model.dart';

class TsignupWidget extends StatefulWidget {
  const TsignupWidget({super.key});

  @override
  State<TsignupWidget> createState() => _TsignupWidgetState();
}

class _TsignupWidgetState extends State<TsignupWidget>
    with TickerProviderStateMixin {
  late TsignupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TsignupModel());
