...
class TmainWidget extends StatefulWidget {
  const TmainWidget({super.key});

  @override
  State<TmainWidget> createState() => _TmainWidgetState();
}

class _TmainWidgetState extends State<TmainWidget> {
  late TmainModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TmainModel());
