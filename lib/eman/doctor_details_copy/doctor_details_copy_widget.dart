...
class DoctorDetailsCopyWidget extends StatefulWidget {
  const DoctorDetailsCopyWidget({super.key});

  @override
  State<DoctorDetailsCopyWidget> createState() =>
      _DoctorDetailsCopyWidgetState();
}

class _DoctorDetailsCopyWidgetState extends State<DoctorDetailsCopyWidget> {
  late DoctorDetailsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DoctorDetailsCopyModel());
  }
