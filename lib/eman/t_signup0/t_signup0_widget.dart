...
import 't_signup0_model.dart';
export 't_signup0_model.dart';

class TSignup0Widget extends StatefulWidget {
  const TSignup0Widget({super.key});

  @override
  State<TSignup0Widget> createState() => _TSignup0WidgetState();
}

class _TSignup0WidgetState extends State<TSignup0Widget>
    with TickerProviderStateMixin {
  late TSignup0Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TSignup0Model());
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 24.0),
                                    child: Text(
                                      'Create an account to start your therapy journey with Mindoria',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
