...
class VirtualTherapistWidget extends StatefulWidget {
  const VirtualTherapistWidget({super.key});

  @override
  State<VirtualTherapistWidget> createState() => _VirtualTherapistWidgetState();
}

class _VirtualTherapistWidgetState extends State<VirtualTherapistWidget> {
  late VirtualTherapistModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VirtualTherapistModel());
  }
