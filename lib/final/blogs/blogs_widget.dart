                                    ...
                                    child: RichText(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text:
                                                'THE ROLE OF SPIRITUALITY ON THE \nHUMAN BEHAVIOUR',
                                            style: FlutterFlowTheme.of(context)
                                                .titleSmall
                                                .override(
                                                  fontFamily: 'Inter Tight',
                        ...
                        child: Column(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                await launchURL(
                                    'https://www.therapyroute.com/article/mood-stabilisers-lithium-valproate-and-lamotrigine-explained-by-therapyroute');
                              },
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.asset(
                        ...
                        child: Column(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                await launchURL(
                                    'https://www.therapyroute.com/article/how-to-spot-a-depression-relapse');
                              },
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.asset(
                        ...
                        child: Column(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                await launchURL(
                                    'https://www.therapyroute.com/article/bipolar-disorder-by-therapyroute-writers-mindful-scribes');
                              },
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.asset(
                                  'assets/images/BIPOLAR.webp',
                                  width: double.infinity,
                                  height: 160.0,
                                  fit: BoxFit.cover,
                                ),
                        ...
                        child: Column(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                await launchURL(
                                    'https://www.therapyroute.com/article/unexplained-sadness-causes-differences-and-support');
                              },
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.asset(
                                  'assets/images/SADNESSS.webp',
                                  width: double.infinity,
                                  height: 160.0,
                                  fit: BoxFit.cover,
                                ),
                          ...
                          children: [
                            InkWell(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.asset(
                                  'assets/images/BIPOLARDISORDER.webp',
                                  width: double.infinity,
                                  height: 160.0,
                                  fit: BoxFit.cover,
                                ),
                                  ...
                                  InkWell(
                                    ...
                                    child: RichText(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text: 'UNDERSTANDING MOOD SWINGS',
                                            style: FlutterFlowTheme.of(context)
                                                .titleSmall
                                                .override(
                                                  fontFamily: 'Inter Tight',
