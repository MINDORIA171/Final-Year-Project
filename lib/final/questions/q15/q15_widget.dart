...
import 'q15_model.dart';
export 'q15_model.dart';

class Q15Widget extends StatefulWidget {
  const Q15Widget({super.key});

  @override
  State<Q15Widget> createState() => _Q15WidgetState();
}

class _Q15WidgetState extends State<Q15Widget> {
  late Q15Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Q15Model());
  }
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Do you feel unsafe at home or in \nyour current environment?',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Inter',
                              letterSpacing: 0.0,
                            ),
                          ...
                          children: [
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  if (FFAppState().progressValue <= 1.0) {
                                    context.pushNamed(
                                      'Mindoria',
